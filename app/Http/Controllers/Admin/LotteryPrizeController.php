...
use App\Http\Resources\Admin\AdminLotteryPrizeResource;
...
class LotteryPrizeController extends Controller
{
    ...
    /**
     * LotteryPrizeController constructor.
     * @param LotteryPrize $service
     */
    public function __construct(LotteryPrize $service)
    {
    ...
    public function index(Request $request)
    {
        ...
        $data =[
            ...
            'list'=>AdminLotteryPrizeResource::collection($paginate)
        ];
    ...
    {
        //
        $data = $this->validateLotteryPrize($request->all());
    ...
    public function show(Request $request,$id)
    {
        ...
        $course = new AdminLotteryPrizeResource($course);
    ...
    protected function validateLotteryPrize($from)
    {
        $rules=[
            'lottery_id'=>'required',
            'name'=>'required',
